...
static void ImGui_ImplGlfw_UpdateKeyModifiers(GLFWwindow* window) {
  ...
  io.AddKeyEvent(
      ImGuiMod_Alt, (glfwGetKey(window, GLFW_KEY_LEFT_ALT) == GLFW_PRESS) ||
...
static int ImGui_ImplGlfw_TranslateUntranslatedKey(int key, int scancode) {
  ...
  if (key_name && key_name[0] != 0 && key_name[1] == 0) {
    ...
    const int char_keys[] = {GLFW_KEY_GRAVE_ACCENT, GLFW_KEY_MINUS,
        ...
        GLFW_KEY_BACKSLASH, GLFW_KEY_COMMA, GLFW_KEY_SEMICOLON,
...
static LRESULT CALLBACK ImGui_ImplGlfw_WndProc(
...
static EM_BOOL ImGui_ImplGlfw_OnCanvasSizeChange(
  ...
  emscripten_get_element_css_size(
      bd->CanvasSelector, &canvas_width, &canvas_height);
...
static EM_BOOL ImGui_ImplEmscripten_FullscreenChangeCallback(int event_type,
    const EmscriptenFullscreenChangeEvent* event, void* user_data) {
  ImGui_ImplGlfw_Data* bd = (ImGui_ImplGlfw_Data*)user_data;
  double canvas_width, canvas_height;
  emscripten_get_element_css_size(
      bd->CanvasSelector, &canvas_width, &canvas_height);
...
void ImGui_ImplGlfw_InstallEmscriptenCallbacks(
    GLFWwindow*, const char* canvas_selector) {
