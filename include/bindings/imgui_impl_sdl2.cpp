...
ImGuiKey ImGui_ImplSDL2_KeyEventToImGuiKey(
...
static void ImGui_ImplSDL2_UpdateGamepadButton(ImGui_ImplSDL2_Data* bd,
    ImGuiIO& io, ImGuiKey key, SDL_GameControllerButton button_no) {
...
static void ImGui_ImplSDL2_UpdateGamepadAnalog(ImGui_ImplSDL2_Data* bd,
    ImGuiIO& io, ImGuiKey key, SDL_GameControllerAxis axis_no, float v0,
    float v1) {
...
static void ImGui_ImplSDL2_UpdateGamepads() {
  ...
  ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadR2,
      SDL_CONTROLLER_AXIS_TRIGGERRIGHT, 0.0f, 32767);
  ImGui_ImplSDL2_UpdateGamepadButton(
  ...
  ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadLStickUp,
      SDL_CONTROLLER_AXIS_LEFTY, -thumb_dead_zone, -32768);
  ...
  ImGui_ImplSDL2_UpdateGamepadAnalog(bd, io, ImGuiKey_GamepadRStickUp,
      SDL_CONTROLLER_AXIS_RIGHTY, -thumb_dead_zone, -32768);
